...
INSERT INTO public.products (code, name, category, package_size, description, image, spec_sheet_url, features, is_featured, display_order) VALUES ('GUST-NEW-05', 'Caja Exhibidora Wafer Cocada Gustaff 18g', 'galletas', 'Empaque Individual', 'Exquisito producto Gustaff: Caja Exhibidora Wafer Cocada Gustaff 18g. Ideal para toda la familia.', '/images/bodegon/caja_exhibidora_wafer_cocada_gustaff_25g.png', '/docs/FT-GUST-NEW-05-Gustaff.pdf', ARRAY['Sabor delicioso', 'Calidad Gustaff'], false, 17) ON CONFLICT (code) DO NOTHING;
...
-- ================================================================
-- CONFIGURACION DE STORAGE BUCKETS
-- ================================================================
