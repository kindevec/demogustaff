...
export const translateProduct = (product: Product, lang: Language): Product => {
  ...
  const nameTranslations: Record<string, string> = {
    ...
    'Caja Exhibidora Wafer Cocada Gustaff 18g': 'Gustaff Coconut Wafer Display Box 18g',
    'Caja Exhibidora Wafer Cocada Gustaff 25g': 'Gustaff Coconut Wafer Display Box 18g',
