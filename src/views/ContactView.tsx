...
export const ContactView: React.FC<ContactViewProps> = ({ siteContent, lang }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!captchaVerified) {
      setErrorMsg('Por favor active la casilla reCAPTCHA para verificar que no es un robot.');
      return;
    }
    ...
    try {
      ...
      setErrorMsg('Ocurrió un error al enviar el mensaje. Intente de nuevo.');
    } finally {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      <div className="bg-[#603813] text-white p-8 sm:p-12 rounded-3xl border border-[#d4af37]/30 shadow-xl text-left space-y-3">
        <span className="text-xs font-bold text-[#d4af37] uppercase tracking-widest bg-white/10 px-3.5 py-1 rounded-full border border-white/20 inline-flex items-center gap-1.5">
          ...
          <span>Atención Directa Gustaff S.A.</span>
        </span>
        ...
        {/* Verbatim Intro Text Requested: "Para sugerencias o inquietudes, ingrese sus datos y atenderemos su petición." */}
        <p className="text-sm sm:text-base text-[#f3ece0] font-medium">
          "{siteContent.contact_intro}"
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ej: Cotización de Cobertura / Sugerencia"
                className="w-full bg-[#fdfaf5] border border-[#e8dcc4] rounded-xl p-3 text-xs text-[#3d2516] placeholder-[#8d6e63] focus:outline-none focus:border-[#b05d2e]"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Escriba su mensaje o inquietud en detalle..."
            ...
            {/* Verbatim Button Requested: "ENVIAR" */}
            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full bg-[#603813] hover:bg-[#3d2516] text-white font-bold py-3.5 rounded-full text-xs uppercase tracking-widest flex items-center justify-center gap-2 shadow-md transition-all"
            >
        ...
        <div className="lg:col-span-5 space-y-6 text-left">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#e8dcc4] shadow-sm space-y-6">
            ...
            <div className="space-y-4 text-xs text-[#4a3224]">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-[#3d2516]">Dirección de Planta:</h4>
                  <p className="mt-0.5 leading-relaxed">
                    Km 8.5 Vía a Daule, Lotización San Francisco Mz. 2 Solar 3 (Av. Camilo Ponce Mz. 7 Solar 3), Guayaquil, Ecuador.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-[#3d2516]">Líneas Telefónicas:</h4>
                  <p className="mt-0.5">042255773 - 2264756</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-[#3d2516]">Call Center / WhatsApp:</h4>
                  <p className="mt-0.5 text-emerald-700 font-bold">0969718045 (+593 96 971 8045)</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-3xl p-4 border border-[#e8dcc4] shadow-sm text-center space-y-2">
            <div className="bg-[#fdf5e6] h-44 rounded-2xl border border-[#e8dcc4] relative overflow-hidden flex flex-col items-center justify-center p-4">
              ...
              <p className="font-serif font-bold text-sm text-[#3d2516]">Guayaquil, Ecuador</p>
              <p className="text-[11px] text-[#6d4c41]">Km 8.5 Vía a Daule, Lotización San Francisco</p>
            </div>
          </div>
        </div>
      </div>
