export const TRANSLATIONS = {
  es: {
    ...
    contactPage: {
      ...
      topNoticeText: "Puede contactarse con nosotros por correo electrónico mediante el siguiente formulario, email de Gustaff S.A. (servicioalcliente@gustaff.com), o por medio de nuestra línea de atención al 042255773 / 2264756 y WhatsApp al 0969718045. Responderemos tan pronto como sea posible. Tenga en cuenta que esta respuesta puede demorarse por fines de semana y días festivos.",
      privacyPolicyNotice: "Le invitamos a leer nuestra Política de Privacidad.",
      leaveMessageHeading: "Déjanos un mensaje",
      mandatoryFields: "* Campos mandatorios",
      reasonLabel: "Por favor indicar la razón por la que nos contacta *",
      reasonQuestion: "Tengo una pregunta",
      reasonComplaint: "Tengo una queja",
      reasonCompliment: "Compartir una felicitación",
      reasonQuote: "Cotización / Comercial",
      subReasonLabel: "Selecciona una razón de contacto *",
      subReasonPlaceholder: "Selecciona una razón de contacto",
      subReasonOpt1: "Información de Productos y Coberturas",
      subReasonOpt2: "Cotización e Inquietud Comercial",
      subReasonOpt3: "Maquila Industrial y Pedidos al Por Mayor",
      subReasonOpt4: "Reclamo o Inquietud de Inocuidad/Calidad",
      subReasonOpt5: "Sugerencias Generales",
      subReasonOpt6: "Otro motivo",
      yourMessageLabel: "Tu Mensaje *",
      attachLabel: "¿Hay algo que quieras adjuntar?",
      attachButton: "Cargar",
      attachMaxLimit: "Peso máximo del archivo: 4MB",
      countryLabel: "País *",
      firstNameLabel: "Nombre *",
      lastNameLabel: "Apellido *",
      secondSectionTitle: "Gracias. Por favor indícanos tu correo y teléfono para ponernos en contacto contigo.",
      emailLabel: "Correo electrónico *",
      phoneGroupLabel: "Teléfono *",
      phoneInputLabel: "Número telefónico *",
      privacyCheckbox: "Entiendo que Gustaff S.A. protegerá mis datos como se describe en el Aviso de privacidad *",
      marketingCheckbox: "Autorizo expresamente a Gustaff S.A. y/o sus afiliadas a contactarme vía email, campañas de remarketing, correo directo, teléfono fijo y/o celular.",
      privacyCheckError: "Por favor acepte el aviso de privacidad para continuar."
    },
    downloadsPage: {
  ...
  en: {
    ...
    contactPage: {
      ...
      cityCountry: "Guayaquil, Ecuador",
      plantSublocation: "Km 8.5 Vía a Daule, Lotización San Francisco",
      topNoticeText: "You can contact us via email using the following form, email Gustaff S.A. (servicioalcliente@gustaff.com), or call 042255773 / 2264756 and WhatsApp 0969718045. We will respond as soon as possible. Please note responses may take longer during weekends and holidays.",
      privacyPolicyNotice: "We invite you to read our Privacy Policy.",
      leaveMessageHeading: "Leave us a message",
      mandatoryFields: "* Mandatory fields",
      reasonLabel: "Please indicate the reason for contacting us *",
      reasonQuestion: "I have a question",
      reasonComplaint: "I have a complaint",
      reasonCompliment: "Share a compliment",
      reasonQuote: "Quote / Commercial",
      subReasonLabel: "Select a contact reason *",
      subReasonPlaceholder: "Select a contact reason",
      subReasonOpt1: "Product & Coating Information",
      subReasonOpt2: "Quotation & Business Inquiry",
      subReasonOpt3: "Industrial Manufacturing & Bulk Orders",
      subReasonOpt4: "Quality / Safety Concern",
      subReasonOpt5: "General Feedback",
      subReasonOpt6: "Other reason",
      yourMessageLabel: "Your Message *",
      attachLabel: "Is there anything you want to attach?",
      attachButton: "Upload",
      attachMaxLimit: "Maximum file size: 4MB",
      countryLabel: "Country *",
      firstNameLabel: "First Name *",
      lastNameLabel: "Last Name *",
      secondSectionTitle: "Thank you. Please provide your email and phone number so we can reach out to you.",
      emailLabel: "Email Address *",
      phoneGroupLabel: "Phone *",
      phoneInputLabel: "Phone Number *",
      privacyCheckbox: "I understand that Gustaff S.A. will protect my data as described in the Privacy Notice *",
      marketingCheckbox: "I expressly authorize Gustaff S.A. and/or its affiliates to contact me via email, remarketing campaigns, direct mail, landline and/or mobile phone.",
      privacyCheckError: "Please accept the privacy policy to proceed."
    },
    downloadsPage: {
