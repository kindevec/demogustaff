...
file_path = r"c:\Users\mkmcm\AA Miyako\DevEC\Trabajos Kindev\Gustaff\demogustaff\src\views\ProductsView.tsx"
...
pattern = re.compile(
    r'<div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-1 md:pb-0">[\s\S]*?</div>\s*</div>',
    re.MULTILINE
)

replacement = """<div className="w-full md:w-auto relative min-w-[220px]">
